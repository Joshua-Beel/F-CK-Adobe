...
- Prepared source metadata for the **0.2.5 draft candidate**. It collects the source-build viewer, page-organization, notice-resource, and cleanup work since 0.2.4; no tag, draft release, or publication has been created. Native desktop interactions, installation, and upgrade/relaunch verification remain open; see [release notes](docs/release-notes.md) and [releases and signing](docs/releases.md).
