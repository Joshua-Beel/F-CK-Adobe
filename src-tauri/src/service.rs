                ...
                match request {
                    ...
                    Request::FormFields(id, revision, reply) => {
                        ...
                        let result = (|| {
                            ...
                            if query.status=="supported" && query.fields.iter().any(|field|field.checked.is_some()||field.radio.is_some()) {
...
mod tests {
    ...
    fn forms_empty_values_require_an_actual_named_engine_field() {
        let expected = vec![crate::forms::FormField {field_id:"opaque".into(),name:"Name".into(),page:0,value:String::new(),max_length:None,checked:None,on_state:None,radio:None}];
