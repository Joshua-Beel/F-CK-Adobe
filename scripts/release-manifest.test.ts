...
describe('release manifest', () => {
  it('points the Windows updater at the exact versioned installer asset', () => {
    ...
    expect(value.platforms['windows-x86_64']).toEqual({ signature: 'signed', url: 'https://github.com/Joshua-Beel/F-CK-Adobe/releases/download/v0.2.0/PDF.Workstation_0.2.0_x64-setup.exe' });
