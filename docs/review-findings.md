...
Combined automated gate: 45 frontend/release tests, 14 native tests, and the production frontend build passed. These checks exercise the current source; the 0.2.4 draft predates these changes.
