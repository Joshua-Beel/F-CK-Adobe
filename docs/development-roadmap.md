...
| Replace pages in a new copy | Insert Pages and Combine preservation rules | Reopened output retains intended order, page content and inherited attributes; originals stay byte-identical; unsupported forms, signatures and references are rejected before mutation. |
