...
- No insert, replace, crop, page labels, page boxes, drag-reorder, or one-file-per-extracted-page yet.
...
Native folder-dialog interaction for splitting remains unverified in the desktop application.
